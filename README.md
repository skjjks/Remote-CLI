...
[![Tests](https://img.shields.io/badge/Tests-297%20passed-brightgreen?style=for-the-badge&logo=vitest&logoColor=white)](#)
[![License](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)](LICENSE)

**Drive your dev box from Feishu — shell, Claude Code, opencode, file sync, all in chat cards.**

在飞书里远程控制服务器、与 AI 编码助手对话、传输文件——就像把 VS Code Terminal + AI Copilot 装进了飞书。不需要 SSH 客户端，一个飞书就够了。
...
| 🎯 模型热切 | `!model` 弹菜单卡点按钮切换；`!model sonnet` 也行 |
| 💼 会话菜单 | `!list` / `!switch`（不带参）弹会话菜单卡，按钮切换或新建会话 |
...
```bash
# 克隆并安装
git clone https://github.com/skjjks/Remote-CLI.git
cd Remote-CLI
npm install
